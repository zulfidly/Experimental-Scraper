<template>
  <div
    class="w-full lg:px-6"
    
    >
    <p class="p-3 border border-[--color-border] bg-[--color-background-soft] rounded-lg w-[inherit] text-center text-md lg:text-lg font-normal lg:font-bold tracking-wide">
