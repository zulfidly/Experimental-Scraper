...
<template>
    <div class="m-1 rounded-xl ">
        <button class="vt-switch lg:hover:border lg:hover:border-[var(--color-soft-oppo)]" type="button" role="switch"
            aria-label="Toggle dark mode"
            :aria-checked="isDarkUser" >
            <span class="vt-switch-check">
                <span class=" vt-switch-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="false" focusable="false" viewBox="0 0 24 24" class="vt-switch-appearance-sun">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="false" focusable="false" viewBox="0 0 24 24" class="vt-switch-appearance-moon">
